...
import { init, exit } from "z-rs-lib";
import type { OperateFunc } from "z-rs-lib";
...
<template>
  <div class="btns">
    ...
    <div class="btn" style="background-color: green" @click="addC(50)">
      +圆形(6)
    </div>
    <div class="btn" style="background-color: orange" @click="addS(2, 3)">
      +条(2,3)
    </div>
    <div class="btn" style="background-color: orange" @click="addS(3, 5)">
      +条(3,5)
    </div>
    <div class="btn" style="background-color: slateblue" @click="getData">
      获取当前数据
    </div>
    <div class="btn" style="background-color: slateblue" @click="posTest">
      定位测试
    </div>
    <div class="btn" style="background-color: slateblue" @click="rCAddTest">
      RC批量新增测试
    </div>
    <div class="btn" style="background-color: sienna" @click="saveToImg">
      保存为图片
    </div>
  </div>
  <div class="content">
